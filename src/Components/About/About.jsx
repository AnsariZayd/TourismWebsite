				...
				<div className='aboutLower'>
					<div className='lowerinfo'>
						...
						<span className='socialHandles'>
							{' '}
							<a href = "https://www.facebook.com/"><FiFacebook color='#EE685F' /></a>{' '}
						</span>
						<span className='socialHandles'>
							{' '}
							<a href = "https://www.instagram.com/"><FiInstagram color='#EE685F' /></a>{' '}
						</span>
						<span className='socialHandles'>
							{' '}
							<a href = "#phone"><FiPhoneCall color='#EE685F' /></a>{' '}
						</span>
						<span className='socialHandles'>
							{' '}
							<a href = "https://www.youtube.com/"><FiYoutube color='#EE685F' /></a>{' '}
						</span>
						<span className='socialHandles'>
							{' '}
							<a href = "https://telegram.org/"><FaTelegram color='#EE685F' /></a>{' '}
						</span>
					</div>
